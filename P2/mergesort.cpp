...
*/
inline static
void mergesort(vector<int> T, int num_elem);
...
*/
static void mergesort_lims(vector<int> T, int inicial, int final);
...
*/
static void fusion(vector<int> T, int inicial, int final, vector<int> U, vector<int> V);
